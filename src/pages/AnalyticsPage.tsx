...
export function AnalyticsPage() {
  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      <StatsCards logsOverride={chartLogs} />
        ...
        <header className="mb-3 flex items-center justify-between">
          <div>
            ...
            <p className="mt-0.5 text-xs text-neutral-500">
              {rangeDays === 7 ? "Selected week" : monthLabel || "Selected month"}
            </p>
          </div>
          ...
          <header className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-[11px] text-neutral-500">
              <span className="uppercase tracking-[0.18em]">
                {rangeDays === 7 ? "7-day window" : monthLabel}
              </span>
              <div className="inline-flex items-center gap-1">
                <button
                  type="button"
                  className="h-6 w-6 rounded-full border border-neutral-700 text-neutral-400 hover:border-amber-500 hover:text-amber-300"
                  onClick={() =>
                    rangeDays === 7
                      ? setWeekOffset((v) => v + 1)
                ...
                <button
                  type="button"
                  className="h-6 w-6 rounded-full border border-neutral-700 text-neutral-400 hover:border-amber-500 hover:text-amber-300 disabled:opacity-40"
                  onClick={() =>
                    rangeDays === 7
